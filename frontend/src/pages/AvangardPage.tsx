...
const potolkiProfile = createPlaceholder('Potolki Profile');
const obshestroy = createPlaceholder('Obshestroy');
const konvektory = createPlaceholder('Konvektory');
const konstrukt = createPlaceholder('Konstrukt');
const gryaz = createPlaceholder('Gryaz');
const lameli = createPlaceholder('Lameli');
const chert = createPlaceholder('Chert');
const logo1 = createPlaceholder('Logo');
const dekor = createPlaceholder('Dekor');
const oknadveri = createPlaceholder('Okna Dveri');
const vent = createPlaceholder('Vent');
const sun = createPlaceholder('Sun');
const dorogi = createPlaceholder('Dorogi');
const santeh = createPlaceholder('Santeh');
const fasad = createPlaceholder('Fasad');
const ventfasad = createPlaceholder('Vent Fasad');
const lodki = createPlaceholder('Lodki');
const pool = createPlaceholder('Pool');
const pergol = createPlaceholder('Pergol');
...
const teplici = createPlaceholder('Teplici');
const electro = createPlaceholder('Electro');
const radiator = createPlaceholder('Radiator');
const moskit = createPlaceholder('Moskit');
const zhaluzi = createPlaceholder('Zhaluzi');
