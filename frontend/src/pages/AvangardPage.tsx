...
const potolkiBg = '/assets/ceiling-BSRJwiq_.jpg';
const potolkiProfile = '/assets/ceiling-BSRJwiq_.jpg';
const obshestroy = '/assets/obshestroy-DhCVfpXy.jpg';
const konvektory = '/assets/konvektory-m-E58eAR.jpg';
const konstrukt = '/assets/konstrukt-IgN1wqIH.jpg';
const gryaz = '/assets/gryaz-CT5JfblF.jpg';
const lameli = '/assets/lameli-BwX8P32X.jpg';
const chert = '/assets/chert-iQjQsZTI.jpg';
const logo1 = '/assets/logo1-jWswJOUv.png';
const dekor = '/assets/dekor-K0GCAjCc.jpg';
const oknadveri = '/assets/oknadveri-Bb0O-J9U.jpg';
const vent = '/assets/vent-XvlR5v74.jpg';
const sun = '/assets/sun-DCcc7EES.jpg';
const dorogi = '/assets/dorogi-DsHHggVC.jpg';
const santeh = '/assets/santeh-DkuCOX19.jpg';
const fasad = '/assets/fasad-BQGsOuf6.jpg';
const ventfasad = '/assets/ventfasad-u_8oxlv2.jpg';
const lodki = '/assets/lodki-B_eINURV.jpg';
const pool = '/assets/pool-D10qiz7W.jpg';
const pergol = '/assets/pergol-oX5QtqGC.jpg';
const lestnici = '/assets/lestnici-CNQbJ2yX.jpg';
const dush = '/assets/dush-CXUkKvaX.jpg';
const lift = '/assets/lift-CFmHvrRZ.jpg';
const porogi = '/assets/borti-Cb__ATK9.jpg';
const auto = '/assets/auto-DnAd25zN.jpg';
const borti = '/assets/borti-Cb__ATK9.jpg';
const shkafi = '/assets/shkafi-B5jgneNk.jpg';
const teplici = '/assets/teplici-EyWi8jli.jpg';
const electro = '/assets/electro-5go7alYE.jpg';
const radiator = '/assets/radiator-CiWVdrfW.jpg';
const moskit = '/assets/moskit-D1tRVqjY.jpg';
const zhaluzi = '/assets/zhaluzi-D1X4Hp2r.jpg';
