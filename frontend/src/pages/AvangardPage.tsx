...
function AvangardPage() {
  ...
  const scrapPrices = {
    'profile-clean': 190, // чистый профиль
    'sheet': 170, // ал. лист
    'chips': 110, // ал. стружка
    'radiators': 115, // ал. радиаторы
    'cans': 100, // ал. банки
    'food': 195, // пищевой
    'mix': 140, // смесь
    'amg': 140, // производственные отходы
    'disks': 150, // диски
    'electrotech': 215, // Электротех
    'plates': 165, // номера
    'typograph_sheets': 170, // типографические листы
    'chips_d16': 100 // стружка д16/16т
  };
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-300 leading-relaxed">
                  Превращаем отходы в доходы (ценное сырье). Высокие цены, быстрая оценка, 
              ...
              <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="space-y-6">
                  ...
                  <div className="text-xs text-white font-bold text-center">
                    * Цены указаны ориентировочно и могут изменяться в зависимости от объёма поставки, качества лома и рыночных условий
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  icon: Phone,
                  title: 'Телефоны',
                  content: '+7 (981) 746-73-30 — отдел продаж/приемка лома\n+7 (999) 215-47-92 — отдел продаж\n+7 (999) 535-15-89 — отдел продаж',
