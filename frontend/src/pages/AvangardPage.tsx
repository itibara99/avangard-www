...
import { potoloch, logo, furnitures } from '../assets/images';

const potolkiBg = potoloch;
const potolkiProfile = potoloch;
const chert = furnitures;
const logo1 = logo;
const obshestroy = furnitures;
const konvektory = furnitures;
const konstrukt = furnitures;
const gryaz = furnitures;
const lameli = furnitures;
const dekor = furnitures;
const oknadveri = furnitures;
const vent = furnitures;
const sun = furnitures;
const dorogi = furnitures;
const santeh = furnitures;
const fasad = furnitures;
const ventfasad = furnitures;
const lodki = furnitures;
const pool = furnitures;
const pergol = furnitures;
const lestnici = furnitures;
const dush = furnitures;
const lift = furnitures;
const auto = furnitures;
const borti = furnitures;
const shkafi = furnitures;
const teplici = furnitures;
const electro = furnitures;
const radiator = furnitures;
const moskit = furnitures;
const zhaluzi = furnitures;
